...
$payoutPayment2 = new Payment();
$payoutPayment2->setAmount("1002.00");
$payoutPayment2->setReferenceCode("1000123-2");
$payoutPayment2->setEmail("comoquepode2@gmail.com");
$payoutPayment2->setBeneficiary($beneficiary);
$payoutPayment2->setScheduledDate("2019-11-29 15:00:00");
$payoutPayment2->setNotes("example-02");

$payments = array(
    "payments" => array(
        $payoutPayment->getData(),
        $payoutPayment2->getData()
    )
);
